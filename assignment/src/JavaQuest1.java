...
public class JavaQuest1 {
  ...
  public static void main(String[] args) {
    ...
    byte b1 = 60;
    byte b2 = 70;
    int sum2 = b1 + b2; // code here with tips, pls fix ...
    // sum = b1 + b2;
    System.out.println("The another sum reuslt is " + sum2);

    boolean varB= false;
    boolean varC= true;// declare two boolean variable with true and false value
    // code here
